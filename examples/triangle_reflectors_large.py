...
if __name__ == '__main__':
    ...
    C, C0, m, d = triangular_reflector(m,reflector_width = [0.2, 0.2], reflector_position =[(0.0, -0.2), (0.0, 0.2)])
    ...
    plt.savefig('decay_triangle_large.png')
    ...
    plt.savefig('reconstruction_triangle_large.png')
    #plt.show()
